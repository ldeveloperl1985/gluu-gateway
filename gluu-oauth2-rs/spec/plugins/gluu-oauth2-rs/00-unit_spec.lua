...
describe("Helper module", function()
    describe("filter_expression_path() function", function()
        ...
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos") == "/todos")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/folder1") == "/todos")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/folder2") == "/todos")

        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users") == "/todos/users")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users/folder1") == "/todos/users")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users/folder1/") == "/todos/users")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users/folder1/folder2") == "/todos/users")

        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users/posts") == "/todos/users/posts")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users/posts/fdf45trgrg") == "/todos/users/posts")
        assert.equals(true, helper.filter_expression_path(json_expression, "/todos/users/posts/folder1") == "/todos/users/posts")
    end)
